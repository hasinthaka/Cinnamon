...
<head>
  <meta charset="utf-8">
  <title>Ceylon Cinnamon Network</title>
    ...
    <section id="featured">
      ...
      <div id="nivo-slider">
        <div class="nivo-slider">
          <!-- Slide #1 image -->
          <img src="img/slides/nivo/bg-33.jpg" alt="" title="#caption-1" />
          <!-- Slide #2 image -->
          <img src="img/slides/nivo/bg-22.jpg" alt="" title="#caption-2" />
          <!-- Slide #3 image -->
          <img src="img/slides/nivo/bg-11.jpg" alt="" title="#caption-3" />
        </div>
        <div class="container">
          <div class="row">
            <div class="span12">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="span12" style="text-align: center;">
            <h4 class="heading"><strong>WHY</strong> US?</h4>
          </div>
          <div style="text-align: center;">
            <p style="font-size: 16px;">
            You are warmly welcome to Ceylon Cinnamon Network. We are the largest Ceylon cinnamon products export network. 
            </p>
            <p style="font-size: 16px;">
              Sri Lanka is the world's most excessive cinnamon producer with high quality who remained best reputation all over the world. 
            </p>
            <p style="font-size: 16px;">
              This platform to Sri Lankan cinnamon Farmers, State owners, Ceylon cinnamon exporting companies and the Global companies to interact with each other’s. 
            </p>
            <p style="font-size: 16px;">
              Members can sell and Purchase cinnamon products, take piece of advices from the experts of cinnamon industry, through advertising, chatting, calling and sending messages so that interact with industry related parties.
            </p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="span12" style="text-align: center;">
            <h4 class="heading"><strong>CEYLON</strong> CINNAMON</h4>
          </div>

          <div class="span12">
            <img src="img/history.jpg" alt="" class="align-left" style="margin-right: 40px;" />
            <p style="font-size: 16px; margin-bottom: 30px; text-align: justify;">
              Sri Lanka is the world's most excessive cinnamon producer and accounts for about 70 per cent of the global production. Sri Lanka has obtained the monopoly of cinnamon production in global market. In Sri Lanka, Cinnamon seems to have originated in the central hills where seven wild species of cinnamon occur in Kandy, Matale, Belihull oya, Haputale, Horton planes and the Sinharaja forest range. Presently cultivation concentrated along the coastal belt from Negambo to Matara, it has also made inroads to Kalutara and Ratnapura. Cinnamon bark is largely available in the form of quills and making quills is unique to Sri Lanka. Quills are made by rolling the pealed bark and join several of them together to get a pipe like structure in the required length. Other than that pieces of bark are available as chips, quilling or featherings. 
            </p>
            <p style="font-size: 16px; margin-bottom: 30px; text-align: justify;">
              Cinnamon is mostly used in cooking and baking. Cinnamon is a versatile spice which can be added to any food item such as salads, confectionaries, beverages, soups, stews and sauces. Cinnamon drink made by immersing pieces of bark in hot water is popular among Latin American countries. Cinnamon flavored tea is becoming popular. It is also used as a common ingredient in Chinese Ayurveda medicine. Cinnamon leaf and bark oils are used to flavor food products, in perfumery industry and in pharmaceutical industry.
